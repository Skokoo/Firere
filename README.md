...
_**If you don't understand what am i saying(Grammar), please click**_  [this](https://github.com/Skokoo/Firere/blob/main/Read%2FVo1)
...
# 🏃 How To run it!
_Copy the Repo_, And run it.

( make sure the terminal/C++ compiler supports **ANSI/ASCII**.(And also a big screen(optional)).

# 📃 License
License = This project uses the [GPL-v3 license.](https://www.gnu.org/licenses/gpl-3.0.html#license-text)
...
Recomended you to read the "fixed grammar" version, if you want.
